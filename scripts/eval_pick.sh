...
#SBATCH --output=slurm_outputs/pick_%j.log
#SBATCH --error=slurm_outputs/pick_%j.err
...
#SBATCH --exclude=neu323,neu314,neu301,neu307
...
echo "[$(date)] Starting eval_lap_pick job on $(hostname)"
...
MUJOCO_GL=egl PYOPENGL_PLATFORM=egl python molmo_spaces/evaluation/eval_main.py \
    ...
    --num_workers 5 \
    --output_dir "eval_output/LAPPolicyEvalConfig/20260407_164647"
EVAL_EXIT=$?
