...
#SBATCH --output=slurm_outputs/open_%j.log
#SBATCH --error=slurm_outputs/open_%j.err
...
#SBATCH --exclude=neu323,neu314,neu301
...
echo "[$(date)] Starting eval_lap_open job on $(hostname)"
