...
#SBATCH --output=slurm_outputs/close_%j.log
#SBATCH --error=slurm_outputs/close_%j.err
...
echo "[$(date)] Starting eval_lap_close job on $(hostname)"
...
MUJOCO_GL=egl PYOPENGL_PLATFORM=egl MLSPACES_CACHE_DIR=/n/fs/robot-data/cache/molmo-spaces-resources python molmo_spaces/evaluation/eval_main.py \
    ...
    --num_workers 5 \
    --output_dir "eval_output/LAPPolicyEvalConfig/20260407_134454"
EVAL_EXIT=$?
